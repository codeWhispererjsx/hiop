...
Each stage is independently persisted, executable, and retryable. Credentialed stages require both policy and an encrypted credential. Evidence records retain source, value, normalization, verification, timestamp, expiry, and weight.
