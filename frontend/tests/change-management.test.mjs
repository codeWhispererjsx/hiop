...
test("change management navigation and protected route are registered",()=>{assert.match(app,/ChangeManagementPage/);assert.match(app,/path="\/changes\/\*"/);assert.match(sidebar,/Change Management/)});
