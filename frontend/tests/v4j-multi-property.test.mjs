...
test("V4J property management remains inside Administration",()=>{assert.match(app,/administration\/properties/);assert.match(sidebar,/label:"Properties"/);assert.doesNotMatch(sidebar,/label: "Properties"/)});
