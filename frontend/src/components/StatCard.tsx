...
export function StatCard({ label, value, detail = "", icon = "dashboard", tone = "neutral", trend }: { label: string; value: number | string; detail?: string; icon?: IconName; tone?: "neutral" | "success" | "danger" | "warning"; trend?: string }) {
