...
export const endpoints = {
  ...
  inviteOrganizationUser:(email:string,role:string,property_id?:string)=>api<{delivery_status:string;test_token?:string;expires_at?:string}>("/accounts/invitations",{method:"POST",body:JSON.stringify({email,role,property_id:property_id||null})}),
  ...
  setBillingExemption:(organizationId:string,exempt:boolean,reason:string)=>api<import("./types").OrganizationSubscription>(`/billing/platform/organizations/${organizationId}/exemption`,{method:"POST",body:JSON.stringify({exempt,reason})}),
