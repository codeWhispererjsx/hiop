...
const installerUrl="https://github.com/codeWhispererjsx/hiop/releases/download/v0.1.3/HIOP-Desktop-0.1.3-x64.exe";
  ...
  return <PublicLayout>
    <section className="onboarding-shell desktop-download-shell">
      ...
      <div className="onboarding-card desktop-download-card">
        ...
        <div className="desktop-download-meta"><span>Windows 10 or later</span><span>Local database included</span><span>Version 0.1.3</span></div>
