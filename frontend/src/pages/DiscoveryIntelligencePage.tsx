...
export default function DiscoveryIntelligencePage() {
  ...
  const visible = useMemo(() => {
    ...
    return devices.filter((device) => {
      ...
      if (typeFilter && (device.classification || device.device_type) !== typeFilter) return false;
...
function dnsMessage(status:string){return ["ptr_found","forward_confirmed","resolved","verified","success"].includes(status)?"DNS information available.":"DNS information unavailable.";}
