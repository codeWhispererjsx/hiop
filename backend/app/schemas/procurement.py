...
class ProcurementCreate(BaseModel):
    title:str=Field(min_length=2,max_length=220);description:str|None=Field(default=None,max_length=4000);reference_number:str|None=Field(default=None,max_length=80);department_id:UUID|None=None;currency:str="NGN";expected_delivery_date:date|None=None;notes:str|None=Field(default=None,max_length=4000);items:list[ProcurementItemCreate]=Field(min_length=1,max_length=100)
...
class ProcurementUpdate(BaseModel):
    title:str|None=Field(default=None,min_length=2,max_length=220);description:str|None=Field(default=None,max_length=4000);reference_number:str|None=Field(default=None,max_length=80);department_id:UUID|None=None;currency:str|None=None;expected_delivery_date:date|None=None;notes:str|None=Field(default=None,max_length=4000)
    @field_validator("currency")
    @classmethod
    def currency_code(cls,value):
