...
class Organization(Base):
    ...
    custom_domain_status: Mapped[str] = mapped_column(String(20), nullable=False, default="unconfigured", server_default="unconfigured")
    custom_domain_verification_token: Mapped[str | None] = mapped_column(String(128))
    custom_domain_verified_at: Mapped[DateTime | None] = mapped_column(DateTime(timezone=True))
    offboarding_status: Mapped[str] = mapped_column(String(30), nullable=False, default="active", server_default="active")
    ...
    erasure_scheduled_for: Mapped[DateTime | None] = mapped_column(DateTime(timezone=True))
